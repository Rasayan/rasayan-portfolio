...
export default function Home() {
  return (
    <main className="w-full h-screen flex justify-center items-center antialiased">
      <div
      ...
      >
        ...
        <div
          className="lg:w-1/2 h-fit flex items-center justify-start
          lg:pl-40 sm:w-full sm:pl-0"
        >
          <h1
...
export const BackgroundBeams = ({ className }) => {
  ...
  return (
    <div
      className={cn(
        "absolute  h-screen w-screen inset-0  [mask-size:100px] [mask-repeat:no-repeat] flex items-center justify-center",
        className
      )}
